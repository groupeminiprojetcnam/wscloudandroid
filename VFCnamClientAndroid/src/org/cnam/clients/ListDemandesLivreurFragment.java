...
public class ListDemandesLivreurFragment  extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	 ...
    	 getActivity().setTitle("Bienvenue "+ clientConnecte.getNomClient() + " " +clientConnecte.getPrenomClient());
    	 /*
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_synchroniser_clients: 
            	Toast toast = Toast.makeText(getActivity(), "Ce bouton est en cours de d�veloppement", Toast.LENGTH_LONG);
                toast.show();
            	return true; 
            default:
